    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='academic_mm_class_and_section.academicclass')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desired_class', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='academic_mm_class_and_section.academicclass', verbose_name='Desired Class for Admission')),
            ],
            options={
